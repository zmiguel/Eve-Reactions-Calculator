	...
	{:else if data.type === 'chain'}
		<div class="row mt-5">
			<div class="col-4">
				...
				<div class="card w-100 mt-4">
					<div class="card-header bg-danger text-white text-center w-100 fw-bold">TOTAL TAXES</div>
					<table width="100%" class="table table-sm table-bordered text-center">
						<thead>
							<tr>
								<th>Name</th>
			...
			<div class="col-4">
				<div class="card w-100">
					...
					<table width="100%" class="table table-sm table-bordered text-center">
						...
						<tbody>
							<tr class="">
								<td>{data.results?.intermediates?.name}</td>
								<td>{data.results?.intermediates?.quantity}</td>
							</tr>
						</tbody>
					</table>
				</div>
